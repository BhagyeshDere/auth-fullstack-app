        ...
        <form onSubmit={handleSubmit} className="space-y-7">
          ...
          <div className="relative">
            <input
              ...
              className="w-full p-4 rounded-xl bg-white/10 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 transition"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold transition duration-300 disabled:opacity-50"
          >
